...
module.exports = {
	...
	// Project options.
	projectURL: 'http://macca/swansong', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	bugReport: 'https://micemade.com/contact/', // Where can users report bugs.
	lastTranslator: 'Alen Sirola <alen@micemade.com>', // Last translator Email ID.
