...
const projectURL = 'http://macca/swansong';
...
const styleSRC = './assets/css/scss/micemade-elements.scss';
...
const jsCustomFile = 'micemade-elements';
...
const watchJsCustom = ['./assets/js/custom/*.js','./assets/js/custom/handlers/*.js'];
...
const zipName = 'micemade-elements.zip';
...
const textDomain = 'micemade-elements';

// Name of the translation file.
const translationFile = 'micemade-elements.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'Micemade Elements';

// Where can users report bugs.
const bugReport = 'https://micemade.com/contact/';

// Last translator Email ID.
const lastTranslator = 'Alen Sirola <alen@micemade.com>';

// Team's Email ID.
const team = 'Micemade <alen@micemade.com>';
